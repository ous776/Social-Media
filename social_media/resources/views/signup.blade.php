                ...
                <div class="row no-gutters">
                    <div class="col-md-6 text-center pt-5">
                        <div class="sign-in-detail text-white">
                            <a class="sign-in-logo mb-5" href="index.html"><img src="../assets/images/logo-full.png"
                            ...
                            <form class="mt-4">
                                ...
                                <div class="sign-info">
                                    ...
                                    <ul class="iq-social-media">
                                        <li><a href="#"><svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                    width="18" viewBox="0 0 16 16" fill="currentColor">
                                        ...
                                        <li><a href="#"><svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                    width="18" viewBox="0 0 24 28" fill="currentColor">
