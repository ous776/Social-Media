...
<body class="  ">
               ...
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li class=" ">
                     <a href="gallery.html" class=" ">
                        <i class="las la-image"></i><span>Gallry</span>
                     </a>
                  </li>
            ...
            <div class="d-grid gap-3 d-grid-template-1fr-19">
                ...
                <div class="card-body text-center">
                    <div class="group-icon">
                        <img src="../assets/images/page-img/p1.jpg" alt="profile-img" class="rounded-circle img-fluid avatar-120" loading="lazy">
                    </div>
                    ...
                    <div class="group-member mb-3">
                        <div class="iq-media-group">
                            ...
                            <a href="#" class="iq-media">
                                <img class="img-fluid avatar-40 rounded-circle" src="../assets/images/user/02.jpg" alt="" loading="lazy">
                            </a>
                            <a href="#" class="iq-media">
                                <img class="img-fluid avatar-40 rounded-circle" src="../assets/images/user/01.jpg" alt="" loading="lazy">
                            </a>
                            <a href="#" class="iq-media">
                                <img class="img-fluid avatar-40 rounded-circle" src="../assets/images/user/03.jpg" alt="" loading="lazy">
                            </a>
                            <a href="#" class="iq-media">
                                <img class="img-fluid avatar-40 rounded-circle" src="../assets/images/user/01.jpg" alt="" loading="lazy">
                            </a>
                ...
                <div class="card mb-0">
                <div class="top-bg-image">
                    <img src="../assets/images/page-img/p2.jpg" class="img-fluid w-100" alt="group-bg" loading="lazy">
                </div>
                <div class="card-body text-center">
                    <div class="group-icon">
                        <img src="../assets/images/page-img/p4.jpg" alt="profile-img" class="rounded-circle img-fluid avatar-120" loading="lazy">
                    </div>
                    <div class="group-info pt-3 pb-3">
                ...
                <div class="card mb-0">
                <div class="top-bg-image">
                    <img src="../assets/images/page-img/profile-bg3.jpg" class="img-fluid w-100" alt="group-bg" loading="lazy">
                </div>
                <div class="card-body text-center">
                    <div class="group-icon">
                        <img src="../assets/images/page-img/gi-3.jpg" alt="profile-img" loading="lazy" class="rounded-circle img-fluid avatar-120">
                    </div>
                    <div class="group-info pt-3 pb-3">
                ...
                <div class="card mb-0">
                <div class="top-bg-image">
                    <img src="../assets/images/page-img/profile-bg4.jpg" class="img-fluid w-100" alt="group-bg" loading="lazy">
                </div>
                <div class="card-body text-center">
                    <div class="group-icon">
                        <img src="../assets/images/page-img/gi-4.jpg" alt="profile-img" class="rounded-circle img-fluid avatar-120" loading="lazy">
                    </div>
                    <div class="group-info pt-3 pb-3">
                ...
                <div class="card mb-0">
                <div class="top-bg-image">
                    <img src="../assets/images/page-img/profile-bg5.jpg" class="img-fluid w-100" loading="lazy" alt="group-bg">
                </div>
                <div class="card-body text-center">
                    <div class="group-icon">
                        <img src="../assets/images/page-img/gi-5.jpg" alt="profile-img" class="rounded-circle img-fluid avatar-120" loading="lazy">
                    </div>
                    <div class="group-info pt-3 pb-3">
                ...
                <div class="card mb-0">
                <div class="top-bg-image">
                    <img src="../assets/images/page-img/profile-bg6.jpg" class="img-fluid w-100" alt="group-bg" loading="lazy">
                </div>
                <div class="card-body text-center">
                    <div class="group-icon">
                        <img src="../assets/images/page-img/gi-6.jpg" alt="profile-img" class="rounded-circle img-fluid avatar-120" loading="lazy">
                    </div>
                    <div class="group-info pt-3 pb-3">
                ...
                <div class="card">
                <div class="top-bg-image">
                    <img src="../assets/images/page-img/profile-bg7.jpg" class="img-fluid w-100" alt="group-bg" loading="lazy">
                </div>
                <div class="card-body text-center">
                    <div class="group-icon">
                        <img src="../assets/images/page-img/gi-7.jpg" alt="profile-img" class="rounded-circle img-fluid avatar-120" loading="lazy">
                    </div>
                    <div class="group-info pt-3 pb-3">
                ...
                <div class="card">
                <div class="top-bg-image">
                    <img src="../assets/images/page-img/profile-bg9.jpg" class="img-fluid w-100" alt="group-bg" loading="lazy">
                </div>
                <div class="card-body text-center">
                    <div class="group-icon">
                        <img src="../assets/images/page-img/gi-8.jpg" alt="profile-img" class="rounded-circle img-fluid avatar-120" loading="lazy">
                    </div>
                    <div class="group-info pt-3 pb-3">
  ...
  <div class="right-sidebar-mini right-sidebar">
   ...
   </div>  <footer class="iq-footer bg-white">
